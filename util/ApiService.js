  ...
  const meditations = {
    list: [
      ...
      },
      {
        ...
        name: "노을이 지는 퇴근길",
        tag: ["직장인", "안정"],
        path: require("../assets/pngImage/img_cover8.png"),
        likeNum: 762,
        isLike: true,
        detail: "노을이 지는 퇴근길.\n명상 설명",
      },
      {
        ...
        name: "여행을 떠나요",
        tag: ["여행", "휴식"],
        path: require("../assets/pngImage/img_cover9.png"),
        likeNum: 30,
        isLike: false,
        detail: "여행을 떠나요.\n명상 설명",
      },
      {
        ...
        name: "아침이 오는 소리",
        tag: ["치유", "잔잔한","Theraphy"],
        path: require("../assets/pngImage/img_cover10.png"),
        likeNum: 167,
        isLike: false,
        detail: "아침이 오는 소리.\n명상 설명",
      },
